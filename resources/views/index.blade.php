...
<body>
    ...
    <header class="text-white bg-stream-dark font-poppins select-none h-full relative">
        <img src="{{asset('stream/assets/images/green_radial.svg')}}" alt="stream" class="absolute"/>
        <img src="{{asset('stream/assets/images/red_radial.svg  ')}}" alt="stream"class="absolute right-0"/>
        ...
        <section class="px-4 relative max-w-[950px] overflow-hidden mx-auto" id="stream">
            ...
            <div class="w-full relative flex">
                <img src="{{asset('stream/assets/images/temp_img.png ')}}" alt="stream"class="object-cover rounded-[50px]" />
        ...
        <section class="relative">
            ...
            <video-js
                ...
                id="stream-video">
                <source src="{{asset('stream/https://d33kv075lir7n3.cloudfront.net/Details+Screen+Part+Final.mp4')}}" type="video/mp4" />
    ...
    <script src="stream/https://cdnjs.cloudflare.com/ajax/libs/video.js/7.10.2/video.min.js"></script>
